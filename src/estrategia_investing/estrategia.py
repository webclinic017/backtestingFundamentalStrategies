...
class TestStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        for i in range(len(self.datas)):
           ...
           comision = 0.5 * self.datas[i].spread[0] / (self.datas[i].close[0])
           ...
           if self.datas[i].eventos1[0]!=0 or self.datas[i].eventos2[0]!=0:
               if self.datas[i].eventos1[0]!=0:
                   self.datos1[i].append(self.datas[i].eventos1[0])
                   self.calcularMedias(i,1)
               if self.datas[i].eventos2[0]!=0:   
                    self.datos2[i].append(self.datas[i].eventos2[0])
